...
class _$_RegisterObject implements _RegisterObject {
  _$_RegisterObject(this.userName, this.email, this.password, this.mobileNumber,
  ...
  @override
  String toString() {
    return 'RegisterObject(userName: $userName, email: $email, password: $password, mobileNumber: $mobileNumber, countryMobileCode: $countryMobileCode, profilePicture: $profilePicture)';
  }
